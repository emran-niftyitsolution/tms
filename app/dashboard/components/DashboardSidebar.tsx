...
export function DashboardSidebar() {
  ...
  return (
    <aside className="lg:col-span-3">
      <div className="sticky top-6 rounded-2xl border border-slate-200/70 bg-white/70 p-5 backdrop-blur dark:border-slate-800 dark:bg-slate-950/40">
        ...
        <div className="mt-6 rounded-2xl bg-slate-900 p-4 text-white dark:bg-white dark:text-slate-900">
          ...
          <div className="mt-3 grid gap-2">
            <Link
              href="/air"
              className="rounded-xl bg-white/10 px-3 py-2 text-sm font-semibold hover:bg-white/15 dark:bg-slate-900/10 dark:hover:bg-slate-900/15"
            >
              Create a booking →
            </Link>
            <Link
