  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      const existingSeats = Array.isArray(formSeats) 
        ? formSeats 
        : (Array.isArray(currentSeats) ? currentSeats : []);
      ...
      const payload = {
        ...
        rows: numRows,
        columns: numColumns,
        aisleColumns: Array.isArray(values.aisleColumns) ? values.aisleColumns : [],
      };
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-100 dark:bg-black dark:ring-slate-800">
          ...
          >
            ...
            <div className="mt-6 flex justify-end gap-4">
              <Button size="large" onClick={() => router.back()} className="rounded-lg">
                Cancel
              </Button>
              <Button
                type="primary"
          ...
          <Form form={form}>
            ...
            >
              <SeatEditor
                ...
                onColumnsChange={(columns) => form.setFieldValue("columns", columns)}
                onAisleColumnsChange={(aisleColumns) => form.setFieldValue("aisleColumns", aisleColumns)}
              />
            </Form.Item>
          </Form>
        </div>
