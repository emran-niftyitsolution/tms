      ...
      <main className="relative overflow-hidden">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center w-full pt-12 lg:pt-0">
              ...
              >
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/80 dark:bg-zinc-800/80 border border-zinc-200 dark:border-zinc-700 backdrop-blur-sm mb-6">
                  ...
                  <span className="text-xs font-medium text-zinc-600 dark:text-zinc-300">#1 Travel Platform in BD</span>
                </div>
                ...
                <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-8 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                  Seamlessly book bus, train, air, and ship tickets. 
                  Experience the future of travel with instant confirmations and 24/7 support.
                </p>

                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <Link href="#search" className="px-8 py-4 rounded-full bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 font-medium hover:scale-105 transition-transform duration-200 shadow-lg hover:shadow-xl">
                    Start Booking
                  </Link>
                  <Link href="/dashboard" className="px-8 py-4 rounded-full border border-zinc-200 dark:border-zinc-800 bg-white/50 dark:bg-black/50 backdrop-blur-sm text-zinc-900 dark:text-white font-medium hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors">
                    View Demo
                  </Link>
                </div>
                ...
                <div className="mt-12 flex items-center justify-center lg:justify-start gap-4">
                   <div className="flex -space-x-4">
                      {[1,2,3,4].map((_, i) => (
                        <div key={i} className="w-10 h-10 rounded-full border-2 border-white dark:border-black bg-zinc-200 dark:bg-zinc-800" />
                      ))}
                   </div>
                   <div className="text-sm">
                      <p className="font-bold text-zinc-900 dark:text-white">50k+ Happy Travelers</p>
        ...
        <section className="py-24 bg-white dark:bg-black relative">
           <div className="container mx-auto px-4 mb-16 text-center max-w-2xl">
              <h2 className="text-3xl md:text-5xl font-bold mb-4 text-zinc-900 dark:text-white">Why Choose TMS?</h2>
              <p className="text-zinc-600 dark:text-zinc-400 text-lg">We&apos;ve re-engineered the booking experience to be faster, safer, and more reliable than ever before.</p>
           </div>
           <FeatureSection />
        </section>
        ...
        <section className="py-24 bg-zinc-50 dark:bg-zinc-900">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-end mb-12">
               <div>
                 <h2 className="text-3xl md:text-4xl font-bold text-zinc-900 dark:text-white mb-2">Trending Destinations</h2>
                 <p className="text-zinc-500 dark:text-zinc-400">Most booked routes this week</p>
               </div>
               <Link href="/air" className="hidden md:flex items-center gap-2 text-indigo-600 dark:text-indigo-400 font-medium hover:underline">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                },
                {
                  ...
                  colSpan: "lg:col-span-4", // Wide banner
                },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                  ...
                  className={`group relative h-80 overflow-hidden rounded-3xl bg-zinc-200 dark:bg-zinc-800 ${item.colSpan || ''}`}
                >
                  <Image
                    src={item.img}
                    alt={item.city}
                  ...
                  <div className="absolute bottom-0 w-full p-6 text-white">
                    ...
                    <p className="text-sm text-zinc-300">Starting from <span className="text-white font-semibold">{item.price}</span></p>
                  </div>
                </motion.div>
              ))}
            </div>
           ...
           <div className="container mx-auto px-4">
              <div className="relative rounded-[3rem] bg-zinc-900 dark:bg-zinc-900 overflow-hidden px-6 py-20 text-center">
                 ...
                 <div className="relative z-10 max-w-3xl mx-auto">
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Ready to travel smartly?</h2>
                    <p className="text-zinc-400 text-lg mb-10">Join thousands of users who have switched to the modern way of booking tickets. Download our app or continue on the web.</p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <button className="px-8 py-4 rounded-full bg-white text-black font-bold hover:bg-zinc-200 transition-colors">Download App</button>
                        <button className="px-8 py-4 rounded-full border border-zinc-700 text-white font-bold hover:bg-zinc-800 transition-colors">Continue Web</button>
                    </div>
                 </div>
              </div>
           </div>
